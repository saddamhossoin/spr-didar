  ...
  <table width="700" border="0"   class="product_table" cellspacing="0" cellpadding="0">
    <tbody>
      ...
      <tr>
       ...
       <td height="20" class="captionLeft" >&nbsp;<span><?php 
	   // pr($posSale);
	   if($posSale['PosCustomer']['PosCustomerLedger'][0]['account_head_id'] !=3){ echo 'Bank';}
	   
	   else{echo $accountsheads[$posSale['PosCustomer']['PosCustomerLedger'][0]['account_head_id']];}?></span></td>
